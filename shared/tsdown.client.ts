/**
 * Shared tsdown preset for UI plugin client bundles. Emits a
...
/**
 * Externals resolved from the loader module table: exactly the platform seed
 * entries, so an import the shell cannot answer is a build error rather than a
 * silent duplicate instance.
 */
